...
As a frontend programmer learning a CSS framework with the following documentation:
```Customizing Colors
Customizing the default color palette for your project.

Following color scale starts with the brightest and ends with the darkest one.
...
But when you do need to customize your palette, you can configure your colors under the colors key in the theme section of your  example:
module.exports = {
  theme: {
    colors: {
...
Always strictly follow answer rules:
- answer ultra shortly
- give only an asked element
- no additional property values
- no comments
- no formatting

Examples:
when asking about button
```
<button class="blah">click</button>
```

when asking about paragraph
```
<p class="sth">text</p>
```